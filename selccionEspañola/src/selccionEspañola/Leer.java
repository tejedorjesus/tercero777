...
package selccionEspañola;import java.io.BufferedReader;
...
public class Leer {
	...
	/**
	 * @param texto
	 *            - Referencia al contenido del dato solicitado
	 ...
	 *            - Referencia al contenido del dato solicitado
	 * @param regex
	 *            - expresión regular a aplicar. Si es null no aplica ninguna
	 * @return dato - cadena introducida por teclado
	 */
	 ...
	 *            - Referencia al contenido del dato solicitado
	 * @param regex
	 *            - expresión regular a aplicar. Si es null se aplica un entero
	 *            genérico
	 * @return dato - Entero tecleado
	 */
	 ...
	 *            - Referencia al contenido del dato solicitado
	 * @param regex
	 *            - expresión regular a aplicar. Si es null se aplica un double
	 *            genérico
	 * @return dato - Double tecleado
	 */
	 ...
	 *            - Referencia al contenido del dato solicitado
	 * @param regex
	 *            - expresión regular a aplicar. Si es null se aplica un float
	 *            genérico
	 * @return dato - Float tecleado
	 */
