		...
		while (opcion != 0) {
			...
			case 1:
				...
				if (MapaMenu.containsKey(plato1)) {// COMO HAGO PARA PODER
													// METERLE MAYUSCULAS
					System.out
							.println("Perfecto disponemosde ese plato en el menú ahora vamos a por el segundo plato ");
				...
				if (respuesta.equals("si")) {
					...
					System.out.println("La cantidad total a pagar es " + precioTotal + " Euros");
				} else {
