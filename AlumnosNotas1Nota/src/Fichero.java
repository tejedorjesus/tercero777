...
public class Fichero {
	...
	public Alumno leer( ) { // lee un objeto de clase Persona y lo devuelve
		Alumno persona=null;
		try {
			persona = (Alumno) entrada.readObject();//leemos un registro
	...
	public Boolean escribir(TreeMap<String,ArrayList<Integer>> MapaNombre){
		
		try {
			if(MapaNombre!=null){//si el objeto existe lo escribimos
				salida.writeObject(MapaNombre);
			}
